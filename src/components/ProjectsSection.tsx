        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <ScrollReveal className="group glass-card overflow-hidden rounded-2xl">
            <a href="https://2023.nssc.in" target="_blank" rel="noopener noreferrer" className="block">
              ...
              <div className="p-8">
                <h3 className="font-headline-md text-headline-md mb-4 group-hover:text-primary transition-colors">National Students’ Space Challenge</h3>
          ...
          <ScrollReveal className="group glass-card overflow-hidden rounded-2xl">
            <a href="https://github.com/sethiaeeshaan/aircanvas" target="_blank" rel="noopener noreferrer" className="block">
              ...
              <div className="p-8">
                <h3 className="font-headline-md text-headline-md mb-4 group-hover:text-primary transition-colors">Air Canvas</h3>
